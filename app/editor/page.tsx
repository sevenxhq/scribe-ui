              ...
              <ResizablePanelGroup direction="horizontal" className="w-full">
                    ...
                    <ResizablePanel defaultSize={50}>
                      <div className="px-5 py-2.5 space-y-5">
                        ...
                        <p className="dark:text-zinc-50 text-zinc-700 text-sm  font-medium tracking-wide leading-4">
                          Cierto dia, Jesús llegó de Nazaret de Galilea, y Juan
                          lo bautizó en el rio Jordán.
                        </p>
                      </div>
                    </ResizablePanel>
                    <ResizableHandle />
                ...
                <ResizablePanel className="p-2.5" defaultSize={32}>
                  ...
                  <article className="dark:text-zinc-50 px-2 text-zinc-700 leading-[18px] mt-2.5   text-xs tracking-wide text-center whitespace-pre-line">
                    1:9b and was baptized by John in the Jordan. and [then] John
                    baptized Jesus/him in the Jordan [River]. -OR- • [When he
                    arrived at the place where John was preaching,| John
